...
export default function CryptoVsForexJournalingDe() {
  return (
    ...
    >
      ...
      <P>
        Viele Forex-Trader sehen diese 20-%-Position und denken, sie seien zu konservativ. Auf Forex sind sie es gewohnt, mit einem $10.000-Konto Währung im Wert von $33.000 (0,33 Lots) zu kontrollieren — 3,3× Leverage. Also skalieren sie ihre Krypto-Position hoch, damit sie sich „normal anfühlt". So werden Konten gesprengt. Die <Link to="/blog/de/1-percent-risk-rule" className="text-kmf-accent hover:underline">1-%-Risikoregel</Link> ändert sich nicht zwischen Märkten, aber die <Link to="/blog/de/position-sizing-guide" className="text-kmf-accent hover:underline">Positionsgröße</Link>, die sie erzeugt, schon — dramatisch. Vertraue der Mathematik, nicht dem Gefühl.
      </P>
