...
export default function CryptoVsForexJournalingFr() {
  return (
    ...
    >
      ...
      <P>
        Beaucoup de traders forex voient cette position à 20 % et pensent qu'ils sont trop conservateurs. Sur le forex, ils ont l'habitude de contrôler 33 000 $ de devise (0,33 lot) avec un compte de 10 000 $ — 3,3× de levier. Alors ils grossissent leur position crypto pour qu'elle « semble normale ». C'est ainsi que les comptes se crament. La <Link to="/blog/fr/1-percent-risk-rule" className="text-kmf-accent hover:underline">règle des 1 %</Link> ne change pas entre les marchés, mais la <Link to="/blog/fr/position-sizing-guide" className="text-kmf-accent hover:underline">taille de position</Link> qu'elle produit, si — dramatiquement. Fais confiance aux maths, pas au ressenti.
      </P>
