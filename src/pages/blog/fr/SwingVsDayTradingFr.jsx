...
export default function SwingVsDayTradingFr() {
  return (
    ...
    >
      ...
      <P>
        Le swing trading a ses propres démons, mais ce sont des plus lents. Le test principal est de rester assis sur tes mains : regarder une position aller contre toi pendant deux jours sans toucher au stop, ou regarder le profit se construire sans l'encaisser trop tôt. Inconfortable, oui. Mais tu affrontes ce test trois fois par semaine, pas quinze fois par jour — et tu l'affrontes après une nuit complète de sommeil, pas au milieu d'une série de pertes. Moins de décisions sous le feu signifie moins d'occasions pour la <Link to="/blog/fr/revenge-trading" className="text-kmf-accent hover:underline">spirale de revenge trading</Link> de démarrer, et moins de cases cochées sur la <Link to="/blog/fr/overtrading-checklist" className="text-kmf-accent hover:underline">checklist d'overtrading</Link>.
      </P>
