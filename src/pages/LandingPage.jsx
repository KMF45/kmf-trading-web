...
const FAQ_SCHEMA = {
  ...
  mainEntity: [
    ...
    { '@type': 'Question', name: 'Is K.M.F. Trading Journal free?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. Core features like trade logging (15 trades), history, lot calculator, checklists, and a trading diary are free. Premium unlocks unlimited trades, advanced stats, cloud sync, emotion tracking, achievements, and more. You can try Premium free for 7 days — no credit card required.' } },
