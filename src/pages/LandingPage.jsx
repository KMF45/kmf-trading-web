...
const FAQ_SCHEMA = {
  ...
  mainEntity: [
    ...
    { '@type': 'Question', name: 'Is K.M.F. Trading Journal free?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. Core features like trade logging (50/month), history, lot calculator, checklists, and a trading diary are free forever. Premium unlocks unlimited trades, advanced stats, cloud sync, emotion tracking, achievements, and more. You can try Premium free for 14 days — no credit card required.' } },
    { '@type': 'Question', name: 'What is the 14-day free trial?', acceptedAnswer: { '@type': 'Answer', text: 'Every new user gets 14 days of full Premium access for free. You can explore all features — unlimited trades, advanced statistics, emotion tracking, personality profile, achievements, cloud sync, and export — with no commitment. After the trial, you keep free-tier access or subscribe to stay Premium.' } },
    { '@type': 'Question', name: 'What platforms does K.M.F. Trading Journal support?', acceptedAnswer: { '@type': 'Answer', text: 'K.M.F. Trading Journal is available on Android devices (Android 7.0+). Download it from Google Play or join the beta at kmfjournal.com.' } },
    ...
    { '@type': 'Question', name: 'Can I export my trading data?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. Premium users can export trade data to JSON, CSV, and PDF formats, as well as create full cloud backups and restore them on any device.' } },
