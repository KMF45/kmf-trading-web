    ...
    <div className="container mx-auto relative z-10">
      <div className="text-center mb-14 animate-fadeIn">
        ...
        <h2 className="text-4xl sm:text-5xl font-bold mb-4" style={{ letterSpacing: '-0.02em' }}>
          ...
          <span className="text-kmf-text-primary">Improve. Repeat.</span>
        </h2>
        <p className="text-lg text-kmf-text-tertiary max-w-xl mx-auto leading-relaxed">
          Expert articles on statistics, risk management, and trading psychology.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 max-w-4xl mx-auto">
        {highlights.map((post, i) => (
          ...
          >
            ...
            <p className="text-xs text-kmf-accent mt-3 font-semibold">Read article →</p>
          </Link>
        ))}
      </div>
