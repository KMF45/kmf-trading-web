...
export default function BlogArticleLayout({ title, metaTitle, metaDescription, slug, lang = 'en', date, dateISO, dateModified, readTime, category, categoryColor = '#4FC3F7', relatedArticles = [], faqItems = [], howToSteps = [], children }) {
  ...
  // NOTE: No automatic browser-language redirect. Each URL serves its own
  // language; hreflang tags tell search engines about the alternates, and the
  // LanguageSwitcher handles manual switching. Auto-redirecting on detected
  // browser language caused Googlebot to flag canonical URLs as "Page with
  // redirect" and blocked indexing (see GSC, June 2026).
